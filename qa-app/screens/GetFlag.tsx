...
export default function GetFlag(){
    const [flagParam, setFlagParam] = useState<FlagParam>({key:"", default:"", type:"string", userExposed: true})
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.lineContainer}>
                ...
                <Picker
                    ...
                    {FlagTypes.map((item, index) =><Picker.Item key={index} label={item} value={item} />)}
                </Picker>
            </View>

            <LineContainerSwitch label="userExposed" value={flagParam.userExposed} 
            onValueChange={useCallback((userExposed) => {
